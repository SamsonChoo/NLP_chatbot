...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupAsr() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error){
                Log.e("asr","Error happened" + Integer.toString(error));
            }
    ...
    private void setupNlu() {
        ...
        String clientAccessToken = "40e1fe91531446288dcd316becd52b52";
    ...
    private String getWeather() {
        ...
        Request request = new Request.Builder().url("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast").addHeader("accept","application/json").build();
